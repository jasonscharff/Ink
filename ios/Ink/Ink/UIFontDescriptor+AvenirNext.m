...
+(UIFontDescriptor *)preferredAvenirNextLightFontDescriptorWithTextStyle:(NSString *)style {
  return [UIFontDescriptor fontDescriptorWithName:[self preferredLightFontName] size:[self preferredAvenirNextFontDescriptorWithTextStyle:style].pointSize];
}
...
+ (NSString *)preferredLightFontName {
